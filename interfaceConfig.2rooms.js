...
var SYNC_PROPERTIES_MAP = {
	'default': {
		...
		'LOGLIST_TITLE' : 'lst_logsyncaction', // attention aux espaces
	...
	'third': {
		...
		'IOBEYAURL' : 'https://10.211.55.31:8443/iobeya/', //ptf @cap en 3.4
		'ROOM_NAME' : 'CAPGEMINI_MINDEF', //ptf @cap en 3.4
		/*'IOBEYAURL' : 'https://devptf.iobeya.com', //ptf @cap en 3.4
		'ROOM_NAME' : 'CAP - SIAé', //ptf @cap en 3.4*/
	}
};
